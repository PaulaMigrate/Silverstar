...
== D#silver IF ~IsValidForPartyDialog("D#Silver")~ THEN @62
== clone1 IF ~IsValidForPartyDialog("D#Silver")~ THEN @63
== D#silver IF ~IsValidForPartyDialog("D#Silver")~ THEN @64
END

I_C_T Imoenj 56 silclone
== D#Silver IF ~IsValidForPartyDialog("D#Silver")~ THEN @239
== Imoenj IF ~IsValidForPartyDialog("D#Silver")~ THEN @240
END
...
== D#silver IF ~IsValidForPartyDialog("D#Silver")~ THEN @249
END
/////////////////////////////
APPEND D#SILVER
IF
...
== D#silver IF ~IsValidForPartyDialog("D#Silver")~ THEN @317 DO ~SetGlobal("DLittle","GLOBAL",1)~
END Wellyn 8
...
== D#Silver IF ~IsValidForPartyDialog("D#Silver")~ THEN @89
== BHCRYPT IF ~IsValidForPartyDialog("D#Silver")~ THEN @90
END
//////////////////////////////////////
// Gem in Chicken
